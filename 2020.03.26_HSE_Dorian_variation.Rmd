...
## Who N. Dorian worked with?

## Geographically based variation

# \color{colorwhite} Chapter 4. A General Introduction to Speakers and Variables

# \color{colorwhite} Chapter 5 A Close Look at Some Embo Variables and their Use

# \color{colorwhite} Chapter 6 Kin Groups, Peer Groups, and Variation

# \color{colorwhite} Chapter 7 Speech Norms, Accommodation, and Speaking Well in Gaelic Embo

# \color{colorwhite} Chapter 8 Socially Neutral Linguistic Variation: Where, Why, What For, and How?

# \color{colorwhite} Chapter 9 Conclusion
